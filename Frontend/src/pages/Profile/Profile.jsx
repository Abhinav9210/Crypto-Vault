            ...
            <div className="lg:flex gap-32">
              <div className="space-y-7">
                ...
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"14/08/2003"} </p>
                </div>
                <div className="flex">
              ...
              <div className="space-y-7">
                <div className="flex">
                  ...
                  <p className="text-gray-500">{"code with abhinav"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">City : </p>
                  <p className="text-gray-500">{"jalandhar"} </p>
                </div>
                <div className="flex">
                  <p className="w-[9rem]">Postcode : </p>
                  <p className="text-gray-500">{144011} </p>
                </div>
                <div className="flex">
